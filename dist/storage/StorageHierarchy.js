...
var ISubscribableStorageProvider_1 = require("./ISubscribableStorageProvider");
/**
...
var StorageHierarchy = /** @class */ (function () {
    ...
    StorageHierarchy.prototype.dispose = function () {
        ...
        this.storageChangedHandlers.forEach(function (handler, level) {
            var currentLevel = _this.levels[level];
            if (ISubscribableStorageProvider_1.isISubscribableStorageProvider(currentLevel)) {
    ...
    StorageHierarchy.prototype.getUpdateHandlerOnlyIfKeyExist = function (updateLevel, updateUnconditionally) {
        var _this = this;
        return function (key, value) {
            return _this.getAtLevel(key, updateLevel, false).then(function (agedValue) {
                if (agedValue) {
    ...
    StorageHierarchy.logger = Logger_1.Logger.get(StorageHierarchy.name);
