...
exports.RedisPubSubStorageProvider = void 0;
 ...
 */
var RedisPubSubStorageProvider = /** @class */ (function () {
    /**
     ...
     */
    function RedisPubSubStorageProvider(client, config, channel) {
        var _this = this;
        this.client = client;
     ...
     */
    RedisPubSubStorageProvider.prototype.get = function (key) {
        var _this = this;
     ...
     */
    RedisPubSubStorageProvider.prototype.set = function (key, agedValue) {
        var _this = this;
        var serializedKey = this.keySerializer.serialize(key);
        ...
        return this.client.set(serializedKey, serializedAgeValue).then(function (response) {
            ...
            if (_this.channel && isSuccessful) {
                ...
                return _this.channel
                    .publish(_this.channelName, message)
     ...
     */
    RedisPubSubStorageProvider.prototype.delete = function (key) {
        var _this = this;
        var serializedKey = this.keySerializer.serialize(key);
     ...
     */
    RedisPubSubStorageProvider.prototype.keys = function () {
        var _this = this;
        return this.client
            .keys(this.keyPrefix + "*")
     ...
     */
    RedisPubSubStorageProvider.prototype.size = function () {
     ...
     */
    RedisPubSubStorageProvider.prototype.subscribe = function (handler) {
     ...
     */
    RedisPubSubStorageProvider.prototype.unsubscribe = function (handler) {
        var index = this.updateHandlers.indexOf(handler);
        if (index >= 0) {
     ...
     */
    RedisPubSubStorageProvider.prototype.listen = function () {
        var _this = this;
        if (!this.channel) {
        ...
        return this.channel.subscribe(this.channelName).then(function (subscribedCount) {
            ...
            RedisPubSubStorageProvider.logger.info("Listening to channel: " + _this.channelName + ", totalChannels=" + subscribedCount);
            return true;
        });
    };
    RedisPubSubStorageProvider.logger = Logger_1.Logger.get(RedisPubSubStorageProvider.name);
    return RedisPubSubStorageProvider;
}());
exports.RedisPubSubStorageProvider = RedisPubSubStorageProvider;
//# sourceMappingURL=RedisPubSubStorageProvider.js.map