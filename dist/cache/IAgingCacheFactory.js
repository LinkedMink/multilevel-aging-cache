...
var agedQueueMap = new Map([[IAgingCacheOptions_1.AgingCacheReplacementPolicy.FIFO, FIFOAgedQueue_1.FIFOAgedQueue]]);
...
function checkAgingCacheOptionsValid(options) {
    ...
    if (options.replacementPolicy === IAgingCacheOptions_1.AgingCacheReplacementPolicy.FIFO &&
